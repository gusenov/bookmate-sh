...
# Usage:
#  $ "./download-public-books.sh" -u="YOUR_USER_NAME" -l="2048" -o="public-books.json" -c="ipp_key=YOUR_IPP_KEY; ipp_uid=YOUR_IPP_UID;"
...
case $i in
  ...
  --default)
    user=""
    limit=2048
    cookie_value="ipp_key=YOUR_IPP_KEY; ipp_uid=YOUR_IPP_UID;"
...
echo "https://bookmate.com/p/api/v5/users/$user/library_cards?page=1&per_page=$limit"
...
wget --quiet \
     ...
     -O "$output_file" "https://bookmate.com/p/api/v5/users/$user/library_cards?page=1&per_page=$limit"
